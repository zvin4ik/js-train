...
function useSymbolToStringTag() {
  ...
  let myObject = {};
  const customSymbol = Symbol.toString("CustomObject");
  myObject[customSymbol] = "CustomObject";
  myObject[Symbol] = myObject[customSymbol];
...
function useSymbolDescription() {
  ...
  const symbolDescription = Symbol(mySymbol);
