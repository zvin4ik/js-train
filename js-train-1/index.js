...
function isEvenNumber(num) {
  ...
  // Використовуємо оператор залишку від ділення на 2
...
function isPositiveNumber(num) {
  // Перевіряємо, чи число 5 більше 0
...
let message = typeVariable === "number" ? "Це число": typeVariable === "string" ? "Це рядок": typeVariable === "boolean" ? "Це булеве значення": "Це інший тип";
return message;
}
