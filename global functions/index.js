...
let num = isNaN(value);
return num ? "The value is NaN." : "The value is not NaN."
}
...
function encodeURLComponent(urlComponent) {
  ...
  let name = encodeURIComponent(urlComponent);
  return name;
}
...
function decodeURLComponent(urlComponent) {
  ...
  let name = decodeURIComponent(urlComponent);
  return name;
}
